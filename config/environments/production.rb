...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "music_sales_#{Rails.env}"

  config.action_mailer.perform_caching = false

  # Ignore bad email addresses and do not raise email delivery errors.
  # Set this to true and configure the email
  # server for immediate delivery to raise delivery errors.
