class Item < ApplicationRecord
  ...
  validates :manufacturer, :model, :color, :serial_number, format: { with: /\A[a-zA-Z0-9 _.-]+\z/, message: "no special characters allowed"}
  validates :manufacturer, :model, length: { in: 1..20 }

  validates :price, numericality: { less_than: 100000 }

  validates :weight, numericality: { less_than: 10000 }
